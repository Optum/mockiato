...
function _findRoute(path,stack) {
    ...
    stack.forEach(function(layer) {
        ...
        if (layer.name == 'router') {
            ...
            // change made per https://github.com/brennancheung/express-remove-route/pull/9 - JDW
    ...
    found.forEach(function(layer) {
        ...
        if (route) {
            if(_.isEmpty(method)){  // if no method delete all resource with the given path
                ...
                // change made to resolve https://github.com/brennancheung/express-remove-route/issues/3 - JDW
